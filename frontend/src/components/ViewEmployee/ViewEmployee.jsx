...
const ViewEmployee = () => {
  ...
  return (
    ...
    <Container>
      <br></br>
      <div className="p-3 mb-2 bg-secondary text-white"><b>Employee List</b></div>


      <Segment>
        {visible && <Button primary>
          <Link to='/newemployee' style={{ color: '#FFF' }}>Add New</Link>
        </Button>}
        <Table celled>
          <Table.Header>
            <Table.Row>
                ...
                <Table.Row>
                  ...
                  {visible && <><Table.Cell>
                    <Link to='/editemployee'>
                      <Button color='green' onClick={() => setData(data._id, data.name, data.designation, data.location, data.salary)}>Edit</Button>
                    </Link>
                  </Table.Cell>
                    <Table.Cell>
